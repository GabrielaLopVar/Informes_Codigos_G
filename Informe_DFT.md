# _Transformada Discreta de Fourier (DFT)_

## ***¿Qué cambiamos del anterior código?***
...
*Realizamos estos cambios para adoptar un paradigma más orientado a objetos, donde la transformada se conceptualiza como una entidad con estado propio rather que como una calculadora utilitaria. La nueva nomenclatura busca mejorar la legibilidad y autodocumentación del código. La eliminación de funcionalidades complejas respondió a una decisión de simplificación, enfocándose en el cálculo core de la DFT mientras se delega el análisis especializado a métodos futuros o clases derivadas, creando así una base más limpia y mantenible para extensiones posteriores.*
